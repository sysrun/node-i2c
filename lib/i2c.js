...
i2c.prototype.WriteByteData = function(addr, command, bytedata, callback) {
  return wire.i2c_write_byte_data(addr, command, bytedata, callback);
};
...
i2c.prototype.ReadByteData = function(addr, register, callback) {
  return wire.i2c_read_byte_data(addr, register, callback);
};
...
i2c.prototype.readblockdata = function(addr, reg, len, cb) {
  var res = wire.i2c_read_block_data(addr, reg, len, cb);
  return res;
};
